...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CheckConfigSpec) DeepCopyInto(out *CheckConfigSpec) {
	*out = *in
	out.CheckConfig = in.CheckConfig.DeepCopy()
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CheckConfigSpec.
func (in *CheckConfigSpec) DeepCopy() *CheckConfigSpec {
	if in == nil {
		return nil
	}
	out := new(CheckConfigSpec)
	in.DeepCopyInto(out)
	return out
}
