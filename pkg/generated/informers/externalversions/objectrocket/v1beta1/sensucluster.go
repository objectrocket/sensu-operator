...
type SensuClusterInformer interface {
	...
	Lister() objectrocketv1beta1.SensuClusterLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ObjectrocketV1beta1().SensuClusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ObjectrocketV1beta1().SensuClusters(namespace).Watch(context.TODO(), options)
			},
		},
		&apisobjectrocketv1beta1.SensuCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *sensuClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisobjectrocketv1beta1.SensuCluster{}, f.defaultInformer)
}

func (f *sensuClusterInformer) Lister() objectrocketv1beta1.SensuClusterLister {
	return objectrocketv1beta1.NewSensuClusterLister(f.Informer().GetIndexer())
}
