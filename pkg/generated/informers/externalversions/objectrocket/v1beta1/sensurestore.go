...
type SensuRestoreInformer interface {
	...
	Lister() objectrocketv1beta1.SensuRestoreLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ObjectrocketV1beta1().SensuRestores(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ObjectrocketV1beta1().SensuRestores(namespace).Watch(context.TODO(), options)
			},
		},
		&apisobjectrocketv1beta1.SensuRestore{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *sensuRestoreInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisobjectrocketv1beta1.SensuRestore{}, f.defaultInformer)
}

func (f *sensuRestoreInformer) Lister() objectrocketv1beta1.SensuRestoreLister {
	return objectrocketv1beta1.NewSensuRestoreLister(f.Informer().GetIndexer())
}
